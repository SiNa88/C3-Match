...
resident__ = open('D:\\00Research\\matching\\scheduler\\paper\\MoreApps\\MPL.yaml', 'r')
resident_preferences = yaml.full_load(resident__)
resident__.close()

hospital__ = open('D:\\00Research\\matching\\scheduler\\paper\\MoreApps\\DPL.yaml', 'r')
hospital_preferences = yaml.full_load(hospital__)
hospital__.close()

hospital_cap = open('D:\\00Research\\matching\\scheduler\\paper\\MoreApps\\capacities-testbed.yml', 'r')
...
fileObject = open(r"D:\\00Research\\matching\\scheduler\\paper\\MoreApps\\matching-testbed.yaml",'w')

...
#              AWSVirg Google Exo(lg) Exo(med) EGS  Lenovo  NvJ   RPi4   RPi3
    ...
    Tm[2][0] = Inference_high_accuracy_model[0] #[][0] 
    ...
    Tm[2][1] = Inference_high_accuracy_model[1] #[][1]
    ...
    Tm[2][2] = Inference_high_accuracy_model[2] #[][2]
    ...
    Tm[2][3] = Inference_high_accuracy_model[3] #[][3]
    ...
    #print (T[2][3])
    #
    Tm[2][4] = Inference_high_accuracy_model[4] #[][3]
    ...
    Tm[2][5] = Inference_high_accuracy_model[5] #[][3]
    ...
    Tm[2][6] = Inference_high_accuracy_model[6] #[][3]
    ...
    Tm[2][7] = Inference_high_accuracy_model[7] #[][3]
    ...
    Tm[2][8] = Inference_high_accuracy_model[8] #[][3]
    ...
    Tm[3][0] = Low_accuracy_training_model[0] #[][0] 
    ...
    Tm[3][1] = Low_accuracy_training_model[1] #[][1]
    ...
    Tm[3][2] = Low_accuracy_training_model[2] #[][2]
    ...
    Tm[3][3] = Low_accuracy_training_model[3] #[][3]
    ...
    #print (T[3][3])
    #
    Tm[3][4] = Low_accuracy_training_model[4] #[][3]
    ...
    Tm[3][5] = Low_accuracy_training_model[5] #[][3]
    ...
    Tm[3][6] = Low_accuracy_training_model[6] #[][3]
    ...
    Tm[3][7] = Low_accuracy_training_model[7] #[][3]
    ...
    Tm[3][8] = Low_accuracy_training_model[8] #[][3]
    #print(Tm[3][8])
    ...
    Tm[4][0] = High_accuracy_training_model[0] #[][0] 
    ...
    Tm[4][1] = High_accuracy_training_model[1] #[][1]
    ...
    Tm[4][2] = High_accuracy_training_model[2] #[][2]
    ...
    Tm[4][3] = High_accuracy_training_model[3] #[][3]
    ...
    #print (T[4][3])
    #
    Tm[4][4] = High_accuracy_training_model[4] #[][3]
    ...
    Tm[4][5] = High_accuracy_training_model[5] #[][3]
    ...
    Tm[4][6] = High_accuracy_training_model[6] #[][3]
    ...
    Tm[4][7] = High_accuracy_training_model[7] #[][3]
    ...
    Tm[4][8] = High_accuracy_training_model[8] #[][3]

...
resident__ = open('D:\\00Research\\matching\\scheduler\\paper\\CODA\\TPL.yaml', 'r')
resident_preferences = yaml.full_load(resident__)
resident__.close()

hospital__ = open('D:\\00Research\\matching\\scheduler\\paper\\CODA\\RPL.yaml', 'r')
hospital_preferences = yaml.full_load(hospital__)
hospital__.close()

hospital_cap = open('D:\\00Research\\matching\\scheduler\\paper\\CODA\\capacities-testbed.yml', 'r')
...
fileObject = open(r"D:\\00Research\\matching\\scheduler\\paper\\CODA\\matching-testbed.yaml",'w')
#fileObject.writelines(mymatching)
